...
from multiprocessing import Process, freeze_support, JoinableQueue, Queue
...
#            qSonIN1.task_done()    
        elif not qSonIN2.empty(): #si on a quelquechose dans la queue
            mes2 = qSonIN2.get()
            loc = {}
...
freeze_support()
qSonIN1 = Queue() #création de la queue du serveur pyo
